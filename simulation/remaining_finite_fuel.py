...
def main():
    ...
    # print(starting_finite_fuel_list)
    print(np.mean(starting_finite_fuel_list))
    print(np.median(starting_finite_fuel_list))
    print(np.std(starting_finite_fuel_list))
    print(sorted(starting_finite_fuel_list))
